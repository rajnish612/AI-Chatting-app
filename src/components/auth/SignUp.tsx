      ...
      >
        ...
        <div className="flex flex-col items-center gap-3 mb-2">
          ...
          <div className="text-center">
            ...
            <p style={{ color: "var(--text-secondary)", fontSize: 14, marginTop: 4 }}>
              {step === "signup" ? "Get started with Nexus Chat for free" : "Enter the 4-digit code we sent to your email"}
            </p>
          </div>
        </div>
        ...
        >
          ...
          <button
            ...
            style={{
              background: submitting || (step === "otp" && otp.length !== 4) ? "var(--text-muted)" : "var(--accent)",
              boxShadow: submitting ? "none" : "var(--shadow-accent)",
              fontSize: 15,
              letterSpacing: "0.01em",
              cursor: submitting || (step === "otp" && otp.length !== 4) ? "not-allowed" : "pointer",
            }}
            onMouseEnter={(e) => {
          ...
          >
            {submitting ? (step === "signup" ? "Creating Account..." : "Verifying OTP...") : (step === "signup" ? "Create Account" : "Verify & Sign In")}
          </button>
